    ...
    def _row(self, row) -> dict[str, Any]:
        ...
        if isinstance(data["raw_payload"], dict):
            for key in (
                ...
                "canonical_url_status", "source_identity_status",
                "editorial_occurrence_id", "technical_acquisition_id",
                "editorial_occurrence_identity", "technical_acquisition_identity",
                "raw_record_id", "editorial_updated_at",
