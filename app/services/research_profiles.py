...
PROFILES: dict[str, ResearchProfile] = {
    "MNQ_MARKET_RESEARCH": ResearchProfile(
        ...
        (*_GENERAL_RESEARCH_DOMAINS, *_ISSUER_RESEARCH_DOMAINS),
        (),
        1440,
        (
            "scheduled_event",
    ...
    "EVENT_MISSING_FIELDS": ResearchProfile(
        ...
        (),
        1440,
        ("forecast", "consensus", "previous", "previous_revised"),
    ),
    "FED_SPEECH_OUTCOME": ResearchProfile(
        ...
        ("federalreserve.gov", "newyorkfed.org"),
        (),
        10080,
    ...
    "EARNINGS_CONTEXT": ResearchProfile(
        ...
        ("sec.gov", *_ISSUER_RESEARCH_DOMAINS),
        (),
        43200,
        (
            "earnings_schedule",
